        ...
        <div class="space-y-6 text-sm text-slate-custom">
          ...
          <div>
            ...
            <div class="space-y-3">
              ...
              <p>Gaceta UNAM (2023). Instala la UNAM humedales para tratamiento y reutilización del agua (CCH Oriente y ENCiT, programa SECTEI–UNAM–GMI). <a href="https://www.gaceta.unam.mx/instala-la-unam-humedales-para-tratamiento-y-reutilizacion-del-agua/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Enlace</a></p>
              <p>DGCS-UNAM (2022). Con humedales, la UNAM cuenta con instalaciones sustentables. Boletín 1060/2022. <a href="https://www.dgcs.unam.mx/boletin/bdboletin/2022_1060.html" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Enlace</a></p>
              <p>UNAM Global. Humedal artificial en la UNAM: innovación en tratamiento de aguas residuales (CCH Oriente: papiro, carrizo, cola de caballo). <a href="https://unamglobal.unam.mx/global_revista/humedal-artificial-en-la-unam-innovacion-en-tratamiento-de-aguas-residuales/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Enlace</a></p>
              <p>Fundación UNAM. Humedales en la UNAM (CCH Oriente operativo, riego de áreas verdes). <a href="https://www.fundacionunam.org.mx/donde-paso/humedales-en-la-unam/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Enlace</a></p>
